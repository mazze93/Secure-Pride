# Secure Pride Copilot Instructions (v2.0 — superseded)

**Superseded 2026-07-30 by `docs/COPILOT-INSTRUCTIONS.md` v3.0** (the AI Development Charter).
Preserved here for history per the charter's own instruction — archived, not deleted.
